...
public class Constants 
{
	...
	public static final int DEFAULT_TURN_TIME = 60000;
	public static final int MIN_TURN_TIME = 10000;
	public static final int MAX_TURN_TIME = 300000;
	
	public static final int MAX_PLAYERS = 10;
	public static final int MAX_SOLDIERS_PER_PLAYER = 4;
	public static final int MAX_CLIENTS = 10;
	public static final int INITIAL_NUM_SOLDIERS = 2;
	public static final int MAX_FUNCTION_LENGTH = 4096;
	...
	public static final int SHOOTER_RELATIVE_TRAJECTORY = 0;
	public static final int GLOBAL_TRAJECTORY = 1;
