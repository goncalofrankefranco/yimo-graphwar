...
public class NetworkProtocol
{
	...
	public static final int SET_PREVIEW = 44;
	public static final int SET_TURN_TIME = 45;
	public static final int SET_TRAJECTORY_MODE = 46;
	public static final int SET_MAP = 47;
