...
public class GraphPlane extends JPanel implements ActionListener
{
	...
	private void drawPreview(Graphics g, boolean terrainReversed)
	{
		...
		g2d.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
		g2d.setColor(new Color(255, 231, 105, 220));
		g2d.setStroke(new BasicStroke(2.0f, BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND, 10.0f, new float[] { 7.0f, 6.0f }, 0.0f));
	...
	public void setPreviewFunction(Function function)
	{
